...
function handleSubmit() {
    ...
    form.post(`/cooperatives/${props.cooperative.id}/members/${props.member.id}?_method=PUT`, {
        ...
        onSuccess: () => {
            toast.success(`${form.first_name} ${form.last_name} has been updated successfully!`)
        }
    })
}
</script>
                ...
                <div
                    ...
                    <form @submit.prevent="handleSubmit" class="space-y-6">
                        ...
                        <div v-if="['Chairman', 'Treasurer', 'Manager'].includes(form.position)">
                            ...
                            <input v-model="form.suffix" id="suffix" type="text" class="w-full pl-9 rounded-xl border bg-white dark:bg-gray-700 border-gray-500 dark:border-gray-700 p-3 focus:ring-2 focus:ring-indigo-500 focus:outline-none" />
                        </div>
