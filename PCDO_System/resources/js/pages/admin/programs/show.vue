                ...
                <div class="relative px-6 py-6">
                    ...
                    <div class="mb-6 w-full">
                        <div class="relative w-full sm:w-auto">
                            <button @click="showFilterDropdown = !showFilterDropdown"
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span>{{statusFilter === 'all' ? 'Filter by Status' : statusOptions.find(o =>
                                        o.value === statusFilter)?.label }}</span>
                                </div>
                                <div class="flex items-center gap-2">
                            ...
                            <div v-if="showFilterDropdown"
                                class="absolute left-0 mt-2 w-full sm:w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-10">
                                <div class="py-1">
                                    <!-- Total Count Option -->
                                    <button @click="statusFilter = 'all'; showFilterDropdown = false"
                                        ...
                                        <span
                                            class="text-xs bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-2 py-0.5 rounded-full">
                                    ...
                                    <button v-for="option in statusOptions.filter(o => o.value !== 'all')"
                                        :key="option.value"
                        ...
                        <div v-if="statusFilter !== 'all'"
                            class="mt-2 sm:hidden text-sm text-gray-600 dark:text-gray-400">
                            Showing: <span class="font-medium">{{statusOptions.find(o => o.value ===
                                statusFilter)?.label }}</span>
                                    ...
                                    <TableCell class="pl-30 py-3">
                                        ...
                                        <template
                                            ...
                                            <Link v-if="!coop.has_checklist"
                                                :href="`/admin/coopProgram/${coop.coopProgramId}/checklist`"
                                            ...
                                            <div v-else-if="coop.has_checklist && coop.has_amortization"
                                                class="flex gap-2">
                                                <Link :href="`/admin/coopProgram/${coop.coopProgramId}/checklist`"
                                                ...
                                                <Link :href="`/admin/amortizations/${coop.coopProgramId}`"
                    ...
                    <div class="md:hidden space-y-4">
                        <div v-for="(coop, index) in filteredCooperatives" :key="coop.id"
                                    ...
                                    <div class="flex items-center">
                                        <span
                                            ...
                                            <component
                                                ...
                                                class="w-3 h-3"
                                                :class="{ 'animate-spin': coop.program_status?.includes('Ongoing') }" />
                                            <span class="truncate">
                            ...
                            <div v-if="coop.program_status !== 'Finished' && coop.program_status !== 'Resolved'"
                                ...
                                <Link v-if="!coop.has_checklist" :href="`/admin/coopProgram/${coop.coopProgramId}/checklist`"
                        ...
                        <div v-if="filteredCooperatives.length === 0"
