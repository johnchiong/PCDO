...
const pdfUrl = ref('/admin/documentation/downloads')
...
const updateReport = () => {
    pdfLoading.value = true
    pdfUrl.value = `/admin/documentation/downloads?program=${selectedProgram.value}&start_date=${startDate.value}&end_date=${endDate.value}&municipality=${selectedCity.value}&file_type=${selectedFileType.value}`
}
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        <TableRow v-for="coop in yearGroup.cooperatives" :key="coop.id"
                                            @click="$inertia.get(`/admin/documentation/cooperative/${coop.id}`)"
