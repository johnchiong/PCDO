    ...
    <div class="bg-gray-100/90 dark:bg-gray-900 min-h-screen">
      <div class="w-full mx-auto p-6 sm:p-10 space-y-6">
        ...
        <div
          ...
          <!-- Header -->
          <div class="flex items-center justify-between px-14 py-6 border-b border-gray-200 dark:border-gray-700 
                 bg-gradient-to-r from-indigo-500/50 to-purple-500/50 dark:from-indigo-900/30 dark:to-purple-900/30">
            <div class="flex items-center space-x-4">
              <div
                class="p-3 rounded-full bg-indigo-200 text-indigo-600 dark:bg-indigo-900/50 dark:text-indigo-300 text-xl">
                💳
              </div>
          ...
          <!-- Status Highlight -->
          <div v-if="getDueStatus(notification.body)" class="px-14 py-6 text-center text-xl font-bold" :class="{
          ...
          <!-- Letter Body -->
          <div class="px-10 py-2 text-gray-700 dark:text-gray-300 leading-relaxed space-y-6 text-lg">

            <div class="space-y-3 bg-gray-200/50 dark:bg-gray-700/50 rounded-lg p-5">
              <p v-for="line in notification.body.split('\n')" :key="line" class="text-lg" :class="{
