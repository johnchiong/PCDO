...
class AdminDocumentationController extends Controller
{
    ...
    public function show($coopId)
    {
        ...
        return inertia('admin/documentation/show', [
            'cooperative' => [
                ...
                'finished_coop_program_checklist' => $coopProgram->finishedChecklist->map(function ($item) {
                    return [
                        ...
                        'status' => $item->status ?? '',
                        'file_url' => route('admin.documentation.checklist.file', $item->id),
                    ];
                }),
                ...
                'resolved' => $coopProgram->resolvedItems->map(function ($resolved) {
                    return [
                        ...
                        'file_url' => route('admin.documentation.resolved.file', ['id' => $resolved->id]),
                    ];
                }),
            ],
        ]);
