...
class AmortizationOldController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        foreach ($programs as $program) {
            foreach ($program->coopProgram as $coopProgram) {
                $coopProgram->olds = AmortizationOld::where('coop_program_id', $coopProgram->id)->get();
            }
        }
    ...
    {
        $record = AmortizationOld::with('cooperative')->findOrFail($id);
