...
async function submit() {
    ...
    form.post('/guest/form', {
        ...
        onError: (errors) => {
            toast.error('An error occurred while saving the inventory. Please try again. Errors: ' + JSON.stringify(errors))
        }
    })
}
</script>
                ...
                <div class="form-grid">
                    <div>
                        ...
                        <Input class="form-input" :class="{ 'error-border': fieldErrors.name }" v-model="form.name"
                            name="name" @input="form.name = sanitizeGeneralName(form.name); clearFieldError('name')" />
                    </div>
                    ...
                    <div>
                        ...
                        <Input class="form-input" :class="{ 'error-border': fieldErrors.email }" v-model="form.email"
                            name="email" @input="form.email = sanitizeEmail(form.email); clearFieldError('email')" />
                    </div>
                    ...
                    <div>
                        ...
                        <Input class="form-input" :class="{ 'error-border': fieldErrors.number }" v-model="form.number"
                            name="number"
            ...
            <div class="form-card" id="location">
                <div class="form-grid">
                    ...
                    <div>
                        ...
                        <div :class="{ 'error-border': fieldErrors.city_code }" @click="clearFieldError('city_code')">
                            <SelectSearch :clearOnFocus="true" :items="filteredCities" itemLabelKey="name"
                                itemKeyProp="code" v-model:search="searchState.city_code" :modelValue="form.city_code"
                                ...
                                <div class="form-grid">
                                    ...
                                    <div>
                                        ...
                                        <div :class="{ 'error-border': fieldErrors[`item-${getItemIndexById(item.id)}-granting_agency`] }"
                                            ...
                                            <SelectSearch :items="getGrantingAgencyOptions()" itemLabelKey="name"
                                                ...
                                                :clearOnFocus="false" v-model:open="grantingAgencyOpenState[item.id]"
                                                @update:search="val => {
                                    ...
                                    <div>
                                        <label class="form-label">
                                            ...
                                            <span v-if="fieldErrors[`item-${getItemIndexById(item.id)}-item_picture`]"
                                                class="error-star">*</span>
                                        </label>
                                    ...
                                    <div>
                                        <label class="form-label">
                                            Acquired Date
                                            <span v-if="fieldErrors[`item-${getItemIndexById(item.id)}-acquired_date`]"
                                                class="error-star">*</span>
                                        </label>
                                        <Input class="form-input"
